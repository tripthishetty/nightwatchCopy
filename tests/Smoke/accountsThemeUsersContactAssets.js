var signIn =  function(driver)
  ...
  var confirmAdminusers = function(driver)
  {
    ...
    .click("//div[@class='tabs-navbar']/a[5]")
    .pause(2000)
    .saveScreenshot('screenshots/verifyUsersPageAfterConfirmation.png')
    .pause(2000)
  }
  ...
  var verifyAdminLevelRestrictions = function(driver)
  {
    ...
    .click("//input[@class='btn btn-login test-login-button']")
    .pause(2000)
    .saveScreenshot('screenshots/verifyAdminLevel1Restriction.png')
    .pause(2000)
    .click("//button[@class='topbar-menu-toggle test-nav-user']")
    .pause(500)
    .click("//a[@class='test-nav-logout']")
    ...
    .click("//input[@class='btn btn-login test-login-button']")
    .pause(2000)
    .saveScreenshot('screenshots/verifyAdminLevel2Restriction.png')
    .pause(2000)
  }
  var memberSideVerify = function(driver)
  {
    ...
    .useXpath()
    //Verify Login logo
    .saveScreenshot('screenshots/verifyLoginLogo.png')
    .pause(2000)
    ...
    .pause(1000)
    .saveScreenshot('screenshots/verifyTermsCondition.png')
    .click("(//i[@class='fa fa-times dialog-close'])[3]")
    .pause(500)
    //Verify Privacy
    .click("(//a[@href='#/footer/privacy'])[1]")
    .pause(1000)
    .saveScreenshot('screenshots/verifyPrivacy.png')
    .click("(//i[@class='fa fa-times dialog-close'])[3]")
    .pause(500)
    //Verify Disclosure
    .click("#/footer/disclosure'])[1]")
    .pause(1000)
    .saveScreenshot('screenshots/verifyDisclosure.png')
    .click("(//i[@class='fa fa-times dialog-close'])[3]")
    .pause(500)
    //Verify About Us
    .click("(//a[@href='#/footer/about'])[1]")
    .pause(1000)
    .saveScreenshot('screenshots/verifyAboutUs.png')
    .click("(//i[@class='fa fa-times dialog-close'])[3]")
    .pause(500)
     //Verify Contact Us
    .click("(//a[@href='#/contact_us'])[1]")
    .saveScreenshot('screenshots/verifyContactUs.png')
    .pause(2000)
    ...
    .pause(2000)
    .saveScreenshot('screenshots/verifyAccountLogo.png')
    .pause(1000)
    .execute('scrollTo(2000,2000)')
    .saveScreenshot('screenshots/verifyAccountFooter.png')
    .pause(1000)
    ...
    .click("//input[@class='sbut']")
    .pause(2000)
    .saveScreenshot('screenshots/verifyAdminReceivesContactUsEmail.png')
    .pause(2000)
  }
